...
//   Unit1CodingAssigments.LabGrade.java
...

{
...

    {
      ...
      System.out.print("What is the weight of in-class work? (decimal)");

      double inWeight = scan.nextDouble();  // in-class weight

      System.out.print("What is the weight of out-of-class work? (decimal)");

      double outWeight = scan.nextDouble(); // out-of-class weight
